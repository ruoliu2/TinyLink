...
public class LinkTableShardingTest {
  public static final String SQL =
      "CREATE TABLE `t_link_%d` (\n"
          ...
          + "  `full_short_url` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,\n"
          ...
          + ") ENGINE=InnoDB AUTO_INCREMENT=1793073689017749506 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
