package com.ruo.tinylink.admin.common.convention.result;
...
public final class Results {
  ...
  /** build failed response through {@link AbstractException} */
  ...
  /** build failed response through errorCode and errorMessage */
